...
public class HachiwareAnimations {

    public static final Animation ANIM_HACHIWARE_WALK = Animation.Builder.create(1f).looping()
            ...
            .addBoneAnimation("Tail",
                    new Transformation(Transformation.Targets.ROTATE,
                            ...
                            new Keyframe(0.33333f, AnimationHelper.createRotationalVector(0f, 12.5f, 0f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(0.66667f, AnimationHelper.createRotationalVector(0f, -12.5f, 0f),
                                    Transformation.Interpolations.CUBIC),
                            new Keyframe(1f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.CUBIC)))
    ...
    public static final Animation ANIM_HACHIWARE_IDLE = Animation.Builder.create(1f).looping()
